...
export function Hero() {
  ...
  return (
    <section
      ref={container}
      className="relative min-h-screen overflow-hidden bg-azul"
    >
      <Image
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-b from-azul via-azul/80 to-azul/25"
        aria-hidden
      />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 py-8 md:px-6 md:py-10">
        ...
        <div className="mt-12 max-w-3xl md:mt-16 lg:mt-20">
          ...
          <p className="hero-fade mt-6 max-w-md font-myriad text-base text-white md:text-lg">
            Una experiencia creada para quienes quieren descubrir el país desde
            otra perspectiva.
          </p>

          <a
            href="#planes"
            className="hero-fade hero-cta mt-8 inline-block rounded-full bg-amarillo px-8 py-3 font-montserrat text-sm font-bold uppercase tracking-wide text-azul shadow-md md:text-base"
          >
            Reservar
          </a>
        </div>
